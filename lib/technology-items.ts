...
export const technologiesItem: TechnologyItems[] = [
  ...
  { name: "React-Bootstrap", icon: "devicon-reactbootstrap-original" },
  { name: "Material UI", icon: "devicon-materialui-plain" },
  { name: "NPM", icon: "devicon-npm-original-wordmark" },
  { name: "MongoDB", icon: "devicon-mongodb-plain" },
  { name: "Supabase", icon: "devicon-supabase-plain-wordmark" },
